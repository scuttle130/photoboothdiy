#change name back to "camera.py" to get it to run
#I made some modifications to make this awesome program work for me.
#This is a work of art by the original artist, I had nothing to do with it!
#You may have to delete all these lines to the top to get it to run correctly.
import picamera
import pygame
import time
import os
...
def CapturePicture():
    ...
    # filename = os.path.join(imagefolder, 'images', str(imagecounter)+"_"+str(ts) + '.jpg') - changed jpg to png
...
def TakePictures():
    ...
    # temprint.png location change from /Desktop/ to /Photobooth/tempPrint/
    # bgimage.save('/home/pi/Desktop/tempprint.png') # jpg change to png
    # ShowPicture('/home/pi/Desktop/tempprint.png',3) # jpg change to png
    # bgimage2 = bgimage.rotate(90)
    #bgimage2.save('/home/pi/Desktop/tempprint.png') # jpg change to png
    #bgimage2 = bgimage.resize((360, 540))
    #bgimage2 = bgimage.rotate(90)
    bgimage.save('/home/pi/Photobooth/tempPrint/tempprint.png') # jpg change to png
    ShowPicture('/home/pi/Photobooth/tempPrint/tempprint.png',3) # jpg change to png
    #bgimage2 = bgimage.rotate(90)
    #bgimage2 = PIL.resize(bgimage,(10,10))
    #bgimage2 = PIL.Image.resize(bgimage,(10,10))
    #bgimage2.save('/home/pi/Photobooth/tempPrint/tempprint.png') # jpg change to png / changed from bgimage2 to bgimage3
    ImageShowed = False
    ...
    if Printing:
                if (TotalImageCount <= PhotosPerCart):
                        # temprint.png location change from /Desktop/ to /Photobooth/tempPrint/
                        # if os.path.isfile('/home/pi/Desktop/tempprint.png'): # jpg change to png
                        if os.path.isfile('/home/pi/Photobooth/tempPrint/tempprint.png'): # jpg change to png                            
                                # Open a connection to cups
                                conn = cups.Connection()
                                # get a list of printers
                                printers = conn.getPrinters()
                                # select printer 0
                                # change for python3 adding "list()"
                                ...
                                if printqueuelength > 1:
                                        ...
                                        Message = "Currently Printing, Please Wait..."                
                                        UpdateDisplay()
                                        time.sleep(1)
                                else:
                                        # temprint.png location change from /Desktop/ to /Photobooth/tempPrint/
                                        # conn.printFile(printer_name, '/home/pi/Desktop/tempprint.png', "PhotoBooth", {}) # jpg change to png
                                        conn.printFile(printer_name, '/home/pi/Photobooth/tempPrint/tempprint.png', "PhotoBooth", {"media": "4x6in"}) # jpg change to png                                        time.sleep(40)            
                else:
                        Message = "No photo possible..."
                        Numeral = ""
                        UpdateDisplay()
                        time.sleep(1)
